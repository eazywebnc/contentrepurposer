...
export function DashboardPreview() {
  ...
  return (
    <section ref={sectionRef} className="relative py-20 overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-b from-indigo-500/6 to-transparent rounded-full blur-[120px] -z-10" />
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-zinc-400 max-w-2xl mx-auto text-lg">
            One input, dozens of formats. Track performance across every channel.
          </p>
        </motion.div>
        <motion.div style={{ y, scale, opacity }} className="relative mx-auto max-w-5xl">
          <div className="rounded-xl border border-white/[0.08] bg-[#0f0d0a]/90 backdrop-blur-xl shadow-2xl shadow-black/40 overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-white/[0.06] bg-white/[0.02]">
              ...
              <div className="flex-1 flex justify-center">
                <div className="px-4 py-1 rounded-md bg-white/[0.04] border border-white/[0.06] text-xs text-zinc-500 min-w-[240px] text-center">
                  app.contentrepurposer.com/dashboard
                </div>
              </div>
            ...
            <div className="relative aspect-[16/9.5] w-full">
              <Image
                ...
                alt="ContentRepurposer dashboard showing content transformation and analytics"
                fill
          ...
          <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-[70%] h-16 bg-indigo-500/8 rounded-full blur-[40px]" />
        </motion.div>
      </div>
    </section>
  );
